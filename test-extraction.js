...
const { extractProductsNode } = require('../kilo/pipeline/src/services/scraper/langgraph/state');
const logger = require('../kilo/pipeline/src/services/logger');
...
async function testExtraction() {
    ...
    if (newState.products.some(p => p.source === 'json-ld' && p.variants.length === 2)) {
